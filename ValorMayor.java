...
class ValorMayor {
    public static void main(String args[]) {
        ...
        // Usamos nextDouble() para que coincida con el tipo de variable
        v1 = sc.nextDouble();
        ...
        promedio = (v1 + v2 + v3) / 3.0; // Usar 3.0 para asegurar división decimal

        if (v1 == v2 && v2 == v3) {
            
            System.out.println("Los tres numeros son iguales.");
            // Si son iguales, el mayor y el menor son el mismo número
            may = v1;
            men = v1;
